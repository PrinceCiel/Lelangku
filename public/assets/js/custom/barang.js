...
DropzoneManager.init({
    modalAddId: "addBarang",
    modalEditId: "editBarang",
    formAddId: "formAddBarang",
    formEditId: "formEditBarang",
    dzAddSelector: "#dropzone-add",
    dzEditSelector: "#dropzone-edit",
    fotoRequired: true,
    multipleFiles: true, // ← tambah ini
    maxFiles: 5, // ← dan ini
});
